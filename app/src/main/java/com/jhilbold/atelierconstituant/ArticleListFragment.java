...
import com.jhilbold.atelierconstituant.metier.Article;
import com.jhilbold.atelierconstituant.metier.Articles;
...
public class ArticleListFragment extends ListFragment
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		setListAdapter(new ArrayAdapter<Article>(getActivity(), android.R.layout.simple_list_item_activated_1, android.R.id.text1, Articles.ITEMS));
	}
	...
	public void onListItemClick(ListView listView, View view, int position, long id)
	{
		...
		mCallbacks.onItemSelected(Articles.ITEMS.get(position).getId());
	}
